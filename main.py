            ...
            if kbk_user in kbk_list:
                        ...
                        if operation_type is None:
                            with connection.cursor() as cursor:
                                cursor.execute(
	                                ...
	                                VALUES(gen_random_uuid(), '{kbk_user}', current_timestamp, false, NULL, '{kbk_deb}', '{kbk_cred}', '0', 'СУФД.Невыясненные', 0);"""
                                )
                ...
                with connection.cursor() as cursor:
                    cursor.execute(
                        ...
                        VALUES('CУФД.Невыясненные', '{kbk_user}', gen_random_uuid(), current_timestamp, false, NULL, false, '', NULL);
                        """
                    )
